...
// we want to return 1 if there are 12 words and return 0 if there are not, so we can warn the user their secret may be malformed
...
export function isValidSecret(secret: string) {
  ...
  return secretWordCount === acceptableWordCount ? 1 : 0;
}
